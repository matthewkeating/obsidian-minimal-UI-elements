...
2. Create the folder `<your-vault>/.obsidian/plugins/view-actions-mover/` if it does not exist.
...
```bash
ln -s /path/to/obsidian-view-actions-mover \
      /path/to/your-vault/.obsidian/plugins/view-actions-mover
```
